...
void Solution93::dfs(const std::string& s, size_t start) {
...
std::string Solution93::composite_ip(std::vector<std::string>& ip_elements) {
...
std::string Solution93::is_valid_ip_element(const std::string& s, const std::string::const_iterator& begin,
...
std::vector<std::string> Solution93::restoreIpAddresses(std::string s) {
    dfs(s, 0);
