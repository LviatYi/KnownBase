...
Solution295::Solution295() {
    head = new ListNode(0);
    median = head;
}

void Solution295::addNum(int num) {
...
void Solution295::addNum2(int num) {
...
double Solution295::findMedian2() {
