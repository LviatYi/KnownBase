...
bool Swordii63::Trie::TrieNode::has_char(const char& c) const {
...
void Swordii63::Trie::insert(std::string word) {
...
std::string Swordii63::Trie::search_prefix(std::string word) {
    std::string prefix;
...
std::string Swordii63::replaceWords(std::vector<std::string>& dictionary, std::string sentence) {
